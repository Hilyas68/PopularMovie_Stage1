...
class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MoviesAdapterviewHolder> {
    ...
    public MoviesAdapter(Context context, MoviesItemClickListener moviesItemClickListener) {
    ...
    public MoviesAdapterviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        int layoutID = R.layout.movie_item_list;
    ...
    public class MoviesAdapterviewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MoviesAdapterviewHolder(View itemView) {
            super(itemView);
            adapterImage = (ImageView) itemView.findViewById(R.id.movieImg);
